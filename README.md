...
Curso oferecido no LABMAT – FCA/UNICAMP (Limeira)

Este repositório reúne os materiais utilizados no curso introdutório de Python para análise de dados ministrado no LABMAT, o Laboratório de Materiais da Faculdade de Ciências Aplicadas da Universidade Estadual de Campinas (FCA/UNICAMP), campus de Limeira. O curso tem como objetivo familiarizar estudantes e pesquisadores com as ferramentas essenciais de programação científica para tratamento, exploração e visualização de dados, com foco em aplicações em ciência e engenharia de materiais.
